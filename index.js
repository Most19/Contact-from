...
form.onsubmit = (e)=>{
    ...
    xhr.onload = ()=>{ //once ajax loaded
        ...
        if(xhr.readyState == 4 && xhr.status == 200){ //if ajax response status is 200 and ready status is 4 means there is no error
            ...
            //if response is an error like enter valid email address then we'll change status color to red else rest the form
    ...
    let formData = new FormData(form); //creating new Form Data obj. This obj is used to sznd form data
